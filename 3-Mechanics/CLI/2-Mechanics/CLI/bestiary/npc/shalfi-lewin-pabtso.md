...
---
# [Shalfi Lewin](2-Mechanics/CLI/bestiary/npc/shalfi-lewin-pabtso.md)
...
- "desc": "Shalfi casts one of the following spells, requiring no components and using\
    ...
    \ thoughts](/2-Mechanics/CLI/spells/detect-thoughts.md), [minor illusion](/2-Mechanics/CLI/spells/minor-illusion.md)\n\
...
"source":
- "PaBTSO"
"image": "https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/PaBTSO/Shalfi%20Lewin.webp"
```
^statblock
